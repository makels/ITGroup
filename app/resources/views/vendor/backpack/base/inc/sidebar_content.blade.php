...
<li class="nav-item"><a class="nav-link" target="_blank" href="/front/index.html"><i class="la la-eye nav-icon"></i> Frontend</a></li>
...
<li class="nav-item nav-dropdown">
    <a class="nav-link nav-dropdown-toggle" href="#"><i class="nav-icon la la-toolbox"></i> Tools</a>
    <ul class="nav-dropdown-items">
